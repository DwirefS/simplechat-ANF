...
Provides object storage operations for AI agents using Azure NetApp Files
Object REST API. This plugin mirrors the functionality of BlobStoragePlugin
but uses ANF's S3-compatible API.
...
class ANFStoragePlugin(BasePlugin):
    ...
    Manifest configuration:
        {
            ...
            "type": "anf_storage",
            "endpoint": "https://<your-anf-endpoint>",
            "auth": {
                "type": "key",
    ...
    def _setup_client(self):
        ...
        self.s3_client = boto3.client(
            ...
            region_name='us-east-1'  # Required by boto3, MS docs specify this for AWS CLI
        )
    ...
    def metadata(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": self.manifest.get(
                "description",
                "Plugin for Azure NetApp Files Object REST API operations. "
                "Supports NFS, SMB, and Object REST API access to the same data."
            ),
            "methods": [
                {
                    "name": "list_buckets",
                    "description": "List all buckets in the ANF volume.",
                    "parameters": [],
